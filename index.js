...
//   That means id the 
//   first letter is the same as the last letter,a nd the second letter is the same
//   as the second to last letter, etc. until we reach the middle letter, return true

//   iterate from the begining to the middle 
//     check each letter to the corresponding letter from the end
//       if any letterd don't match return false
